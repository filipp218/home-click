...
class Task(models.Model):
    ...
    author = models.ForeignKey(User, verbose_name="Владелец заявки", on_delete=models.CASCADE,  blank=False, related_name="author_id")
    ...
    worker = models.ForeignKey(User, verbose_name="Работник", on_delete=models.DO_NOTHING, null=True, related_name="worker_id", blank=True)
